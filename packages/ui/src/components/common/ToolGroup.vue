...
<template>
  <div class="tool-group" :class="props.direction" :style="{ '--gap': (props.gap + 'px'), alignItems: alignItemsValue(props.align) }">
    <slot />
  </div>
...
<style scoped>
.tool-group { display: inline-flex; align-items: center; gap: var(--gap); }
.tool-group.vertical { flex-direction: column; }
</style>
